...
<td style="text-align:center">
<input type="button" value="单击下载" style="background-color: #46a4f8; border: none; color: white; padding: 12px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 13px; border-radius: 5px;" onclick="window.open('https://tic-res-1259648581.file.myqcloud.com/demo/tic/TICDemo_Windows.zip')" />
</td>
<td style="text-align:center">
