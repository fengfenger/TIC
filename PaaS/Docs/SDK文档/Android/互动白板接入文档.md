...
| 获取当前文件 ID | getCurrentFile|无
| 获取指定的文件信息 | getFileInfo| 无
| 获取白板中上传的所有文件的文件信息列表 | getFileInfoList|  无
| 获取指定文件的白板 ID 列表 | getFileBoardList|无
| 清空指定文件的所有白板涂鸦 | clearFileDraws| 无
